...
from hsk2.listening.service import service as listening_service
from hsk2.reading.service import service as reading_service


router = Router()

###
CALLBACK_FULL_VARIANT = "hsk2_full"

TEXT_CHOOSE_VARIANT = "Выберите вариант для прохождения:"
TEXT_FULL_TEST_COMPLETED = "Полный тест HSK2 завершен! 🎉"
...
async def start_full_variant(callback: CallbackQuery, state: FSMContext):
    ...
    from hsk2.listening.handlers import start_listening_variant
