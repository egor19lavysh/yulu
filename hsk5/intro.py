...
class Sections:
    listening = "hsk5_listening"
    reading = "hsk5_reading"
    writing = "hsk5_writing"
    words = "hsk5_words"
    full_test = "hsk5_full_test"
...
@router.message(Command("hsk5"))
async def get_sections(msg: Message):
    level_text = "Вы выбрали 5 уровень экзамена HSK"
